...
class User(AbstractBaseUser):
    ...
    image = models.ImageField(verbose_name=_("image"), upload_to='user/images', default='user/images/images.jpeg')
    is_active = models.BooleanField(verbose_name=_("is admin"), default=True)
    is_admin = models.BooleanField(verbose_name=_("is active"), default=False)
